...
The i-th character of s is '.' if the cell i is empty and '#' if cell i is blocked.
...
Then he will remove water from cell 5 and place it into cell 6.
As cell 5's neighbors, cell 4 and cell 6, have water in them, cell 5 also gets filled with water.
