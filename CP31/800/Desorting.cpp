...
/*Desorting
Call an array a of length n sorted if
a1 ≤ a2 ≤ … ≤ an−1 ≤ an.
...
a1, a2, …, an
(1 ≤ ai ≤ 10^9) — the values of array a.
...
[3, 10, 12, 11]
which is not sorted.
It can be proven that 1 and 2 operations are the minimal numbers of operations in the first and second test cases.
