...
The beauty of an array b=[b1,…,bk] is defined as ∑ki=1⌈bi/x⌉, which means that we divide each element by x, round it up to the nearest integer, and sum up the resulting values. For example, if x=3, and the array is [4,11,6], the beauty of the array is equal to ⌈4/3⌉+⌈11/3⌉+⌈6/3⌉=2+4+2=8.
