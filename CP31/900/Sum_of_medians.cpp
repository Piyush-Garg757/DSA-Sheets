...
The second line of the description of each test case contains nk integers a1,a2,…,ank (0≤ai≤10^9) — given array. It is guaranteed that the array is non-decreasing: a1≤a2≤…≤ank.
...
int main()
{
    ...
    while (t--)
    {
        ...
        long long skip_val = n / 2;
        long long i = n * k - 1 - skip_val;
        while (k)
        {
            sum += a[i];
            i -= skip_val;
